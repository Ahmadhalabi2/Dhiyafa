...
// استيراد الخدمة الموحدة بالمسار الصحيح
    ...
    <tr>
      <td align="center" style="padding:0 8px;">
        <table width="100%" cellpadding="0" cellspacing="0" border="0"
          ...
          <tr>
            <td style="background-color:#0E5C4A;background:linear-gradient(135deg,#0E5C4A 0%,#0A4437 100%);padding:20px 16px;text-align:center;">
              <div style="display:inline-block;background-color:rgba(255,255,255,0.15);border-radius:8px;padding:4px 14px;margin-bottom:6px;">
          ...
          <tr>
            <td style="padding:20px 16px;">
              ...
              <div style="background-color:#F8F4EA;background:linear-gradient(135deg,#F8F4EA 0%,#EDE6D6 100%);border:1.5px solid #C69A3A;border-radius:12px;padding:12px 10px;text-align:center;margin-bottom:16px;">
                <p style="margin:0 0 4px;font-size:10px;color:#8A6A1F;letter-spacing:1px;text-transform:uppercase;font-weight:700;">رقم الحجز</p>
                <span style="font-size:14px;font-weight:800;color:#0E5C4A;font-family:'Courier New',monospace;display:block;word-break:break-all;direction:ltr;">${id}</span>
              </div>
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#F8F4EA;border-radius:10px;border:1px solid #E5DFC8;margin-bottom:16px;">
                <tr>
              ...
              <div style="background-color:#0E5C4A;background:linear-gradient(135deg,#0E5C4A 0%,#0A4437 100%);border-radius:12px;padding:12px 14px;margin-bottom:16px;">
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                  <tr>
              ...
              <div style="background-color:#FFF8EC;border:1px solid #F5D87A;border-radius:10px;padding:10px 12px;">
          ...
          <tr>
            <td style="background-color:#F8F4EA;padding:12px 16px;border-top:1px solid #EDE6D6;text-align:center;">
